...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Join Our Supplier Network - Lumino Logistics</title>
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <h1 class="text-2xl font-bold text-blue-600">Lumino Logistics</h1>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center">
                <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                    Ready to Join Our
                    <span class="text-blue-600">Supplier Network?</span>
                </h1>
                <p class="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    Partner with Lumino Logistics and become part of a growing ecosystem of trusted suppliers. 
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                    Why Partner With <span class="text-blue-600">Lumino Logistics?</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Join our network and enjoy exclusive benefits designed to help your business grow.
                </p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center p-6">
                    ...
                    <p class="text-gray-600">Fair rates and timely payments to ensure your business thrives.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-600">Consistent project opportunities and long-term partnerships.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Quality Support</h3>
    ...
    <section id="process" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                    Simple <span class="text-blue-600">Onboarding Process</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Get started in four easy steps and begin receiving projects quickly.
                </p>
            </div>
            <div class="grid md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm">Submit your application with company details</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm">We review and verify your credentials</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-sm">Receive confirmation and access to our platform</p>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="font-semibold mb-2">Start Working</h3>
                    <p class="text-gray-600 text-sm">Begin receiving and delivering projects</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="requirements" class="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                    Supplier <span class="text-blue-600">Requirements</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    We partner with qualified suppliers who meet our quality standards.
                </p>
            </div>
            <div class="grid md:grid-cols-2 gap-12">
                <div>
                    <h3 class="text-xl font-semibold mb-4">Business Requirements</h3>
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-start">
                            ...
                            <span>Minimum 2 years in business operation</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span>Insurance coverage and liability protection</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span>Financial stability and good credit standing</span>
                        </li>
                    </ul>
                </div>
                <div>
                    <h3 class="text-xl font-semibold mb-4">Quality Standards</h3>
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span>Proven track record of quality service</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span>Professional certifications and qualifications</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span>Commitment to safety and compliance</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span>Excellent customer references</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section id="contact" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Have questions? Our supplier relations team is here to help.
                </p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">suppliers@lumino-logistics.com</p>
                    <p class="text-gray-500 text-sm">24-48 hour response time</p>
                </div>
                <div class="text-center">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-600">123 Logistics Ave</p>
    ...
    <!-- CTA Section -->
    <section id="apply" class="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
    ...
    <footer class="bg-gray-900 text-gray-300 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-white font-bold text-xl mb-4">Lumino Logistics</h3>
                    <p class="text-sm">Your trusted partner in logistics and supply chain solutions.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="hover:text-white">Supplier Portal</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="#" class="hover:text-white">Supplier Agreement</a></li>
                        <li><a href="#" class="hover:text-white">Compliance</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
                <p>&copy; 2024 Lumino Logistics. All rights reserved.</p>
            </div>
        </div>
    </footer>
